...
/*
Demonstração do uso de UNION, trará no resultset linhas únicas, ou seja, sem repetição de valores na combinação das colunas
*/
...
/*
Demonstração do uso de UNION ALL, trará no resultset linhas que podem ter repetição de valores na combinação das colunas
*/
...
/*
Demonstração do uso de INTERSECT, trará no resultset linhas cujos valores de todas as colunas combinadas tem o mesmo correspondente entre as queries envolvidas
*/
...
/*
Demonstração do uso de EXCEPT, trará no resultset linhas cujos valores de todas as colunas combinadas não possuam um mesmo correspondente entre as demais queries envolvidas
*/
