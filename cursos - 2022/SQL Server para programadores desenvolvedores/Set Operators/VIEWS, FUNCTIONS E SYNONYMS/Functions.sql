...
/*
Demonstração de criação e uso de VIEW
*/
...
SELECT "Código pedido", Quantidade, "Valor Unitario", "Data Venda" 
...
/*
Demonstração de criação e uso de VIEW com SCHEMABINDING, para não permitir alterações nas tabelas envolvidas
*/
...
/*
Demonstração de criação e uso de VIEW com encriptação, para esconder a definição da VIEW
*/
...
/*
Demonstração de como alterar de uma VIEW existente
*/
...
/*
Demonstração de como excluir de uma VIEW existente
*/
...
/*
Demonstração de criação e uso de Scalar FUNCTION
*/
...
/*
Demonstração de criação e uso de Table Valued FUNCTION
*/
...
SELECT Produto, "Código pedido", Quantidade, "Valor Unitario", "Data Venda" 
...
/*
Demonstração de criação e uso de Table Valued FUNCTION com SCHEMABINDING e ENCRYPTION 
*/
...
/*
Demonstração de Table Valued FUNCTION com tabela temporária
*/
...
/*
Demonstração de criação e uso de sinônimo 
*/
